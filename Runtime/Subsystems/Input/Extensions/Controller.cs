        ...
        public static partial class Extensions
        {
            public static class Controller
            {
	            ...
	            private static MLResult SetCallbacks()
	            {
		            ...
		            var result = NativeBindings.MLInputSetControllerCallbacksEx(LuminXrProviderNativeBindings.GetInputHandle(), ref callbacks, 
			            IntPtr.Zero);
                ...
                internal class NativeBindings : MagicLeapNativeBindings
                {
		            ...
		            public static extern MLResult.Code MLInputCreate(IntPtr OutHandle);
