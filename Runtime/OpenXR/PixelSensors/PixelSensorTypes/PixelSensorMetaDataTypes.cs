...
{
    /// <summary>
    /// The base class for all metadata types. <see cref="PixelSensors.MagicLeapPixelSensorFeature.GetSensorData"/> will return an array of instances of the base class type
