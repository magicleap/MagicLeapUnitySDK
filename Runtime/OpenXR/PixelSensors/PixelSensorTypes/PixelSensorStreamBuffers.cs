...
namespace MagicLeap.OpenXR.Features.PixelSensors
{
    ...
    internal class PixelSensorStreamBuffer
    {
        ...
        public PixelSensorStreamBuffer(uint streamIndex, PixelSensor sensor)
        {
            ...
            this.sensor = sensor;
            nativeFunctions = sensor.NativeFunctions;
        }
        ...
        public void AllocateBuffer()
        {
            unsafe
            {
                ...
                Utils.OpenXRStructHelpers<XrPixelSensorBufferProperties>.Create(XrPixelSensorStructTypes.XrTypePixelSensorBufferPropertiesML, out var bufferProperties);
