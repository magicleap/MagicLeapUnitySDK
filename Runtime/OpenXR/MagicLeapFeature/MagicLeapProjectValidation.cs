...
namespace MagicLeap.OpenXR.Features
{
    public partial class MagicLeapFeature
    {
        ...
        private OpenXRFeature.ValidationRule[] MagicLeapProjectRules => new OpenXRFeature.ValidationRule[]
        {
            // must build for x86-64
            new OpenXRFeature.ValidationRule(this)
            {
        ...
        private OpenXRFeature.ValidationRule[] MagicLeapProjectRulesEditor => new OpenXRFeature.ValidationRule[]
        {
            // require Vulkan
            new OpenXRFeature.ValidationRule(this)
            {
