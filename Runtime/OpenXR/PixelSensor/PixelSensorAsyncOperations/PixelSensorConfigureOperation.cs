        ...
        internal class PixelSensorConfigureOperation : PixelSensorAsyncOperation
        {
            ...
            protected override bool StartOperation()
            {
                unsafe
                {
                    ...
                    var xrResult = NativeFunctions.XrConfigurePixelSensorAsync(Sensor.Handle, ref startInfo, ref Future);
            ...
            protected override bool OperationCompleted()
            {
                unsafe
                {
                    ...
                    return Utils.DidXrCallSucceed(xrResult, $"{nameof(PixelSensorNativeFunctions.XrConfigurePixelSensorComplete)}BeforeFuture") && Utils.DidXrCallSucceed(completionInfo.FutureResult, nameof(PixelSensorNativeFunctions.XrConfigurePixelSensorComplete));
                }
            }
        }
    }
