...
namespace UnityEngine.XR.OpenXR.Features.MagicLeapSupport
{
    ...
    public partial class MagicLeapPixelSensorFeature
    {
        ...
        /// <summary>
        /// Represents the range type of a pixel sensor capability.
        /// </summary>
        ...
        /// <summary>
        /// The flags associated with <see cref="PixelSensorDepthFlagBuffer"/> with each pixel 
        /// </summary>
        ...
        /// <see cref="PixelSensorFrameFormat"/> represents the frame capabilities supported by a sensor while <see cref="PixelSensorFrameType"/> indicates the type of a frame
        ...
        public enum PixelSensorMetaDataType : uint
        {
            ...
            /// The confidence score is derived from the sensor noise and it is not normalized.
        ...
        internal unsafe struct XrPixelSensorDepthConfidenceBuffer
        {
            ...
            public PixelSensorMetaData GetMetaData(Allocator allocator, bool shouldFlipTexture)
            {
                var buffer = new PixelSensorDepthConfidenceBuffer();
                buffer.Frame.CreateFromNativeFrame(Frame, allocator, shouldFlipTexture);
                return buffer;
            }
        }
