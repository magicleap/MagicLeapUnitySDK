    ...
    public sealed partial class MLCamera
    {
        internal partial class NativeBindings
        {
            ...
            public struct MLCameraMRConnectInfo
            {
                ...
                public static MLCameraMRConnectInfo Create(MRConnectInfo connectInfo)
                {
            ...
            public struct MLCameraConnectContext
            {
                ...
                /// </summary>
                /// <returns>A new instance of this struct.</returns>
                public static MLCameraConnectContext Create(ConnectContext cameraContext)
                {
            ...
            public struct MLCameraCaptureConfig
            {
                ...
                /// </summary>
                /// <returns>A new instance of this struct.</returns>
                public static MLCameraCaptureConfig Create(CaptureConfig config)
                {
            ...
            public struct MLCameraPlaneInfo
            {
                ...
                public PlaneInfo CreatePlaneInfo(bool copyToManagedMemory, byte[] byteArrayToUse = null)
                {
            ...
            public struct MLCameraOutput
            {
                ...
                public CameraOutput CreateFrameInfo(bool copyToManagedMemory, byte[][] byteArraysToUse = null)
                {
                    CameraOutput frameInfo = new CameraOutput()
                    {
                        Planes = new PlaneInfo[this.PlaneCount],
                        Format = this.Format
                    };
