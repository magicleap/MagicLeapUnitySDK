...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLImageTracker
    {
        ...
        public sealed class Target : IDisposable
        {
            ...
            public void Dispose()
            {
                disposePerfMarker.Begin();
                #if UNITY_MAGICLEAP || UNITY_ANDROID
                this.Cleanup();
                #endif

                GC.SuppressFinalize(this);
                disposePerfMarker.End();
            }
            ...
            {
                updateTrackingDataPerfMarker.Begin();
                ...
                if (MagicLeapNativeBindings.MLHandleIsValid(this.trackerHandle) && this.IsValid)
                {
                    ...
                    if (!isReady)
                    {
                        ...
                        updateTrackingDataPerfMarker.End();
                        return;
                    }
#endif
            ...
            public MLResult SetTargetLongerDimension(float longerDimension)
            {
                ...
                setTargetLongerDimensionPerfMarker.Begin();
                ...
                setTargetLongerDimensionPerfMarker.End();
                return result;
            }
