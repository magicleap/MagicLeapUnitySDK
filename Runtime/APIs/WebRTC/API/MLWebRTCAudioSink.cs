    ...
    public partial class MLWebRTC
    {
        ...
        public partial class AudioSink : Sink
        {
            ...
            public static AudioSink Create(out MLResult result, BufferNotifyMode mode = BufferNotifyMode.None)
            {
                ...
                if (!MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkCreateEx()"))
                {
            ...
            public MLResult SetVolume(float volume)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetSoundVolume()");
            ...
            public MLResult SetPosition(Vector3 position, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetPositionEx()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult SetOrientation(Quaternion orientation, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetSoundOrientation()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult SetDirectSendLevels(MLAudioOutput.SpatialSound.SendLevels sendLevels, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetDirectSoundLevels()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult SetRoomSendLevels(MLAudioOutput.SpatialSound.SendLevels sendLevels, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetRoomSoundLevels()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult SetDistanceProperties(MLAudioOutput.SpatialSound.DistanceProperties distanceProperties, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetSoundDistanceProperties()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult SetRadiationProperties(MLAudioOutput.SpatialSound.RadiationProperties radiationProperties, int channel = -1)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetSoundRadiationProperties()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public MLResult ResetPosition()
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkResetPosition()");
                return MLResult.Create(resultCode);
            }
#endif
            ...
            public MLResult SetCacheSize(uint millisecondsToCache)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, $"MLWebRTCAudioSinkSetCacheSize({millisecondsToCache})");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
            ...
            public override MLResult Destroy()
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkDestroy()");
            ...
            protected override MLResult SetTrack(MLWebRTC.MediaStream.Track track)
            {
                ...
                MLResult.DidNativeCallSucceed(resultCode, "MLWebRTCAudioSinkSetSource()");
                return MLResult.Create(resultCode);
#else
                return new MLResult();
#endif
