...
namespace UnityEngine.XR.OpenXR.Features.MagicLeapSupport
{
    ...
    using MagicLeapSpaceInfoNativeTypes;
    
    [System.Obsolete("Type has been relocated to new namespace. Update reference to MagicLeap.OpenXR.Features.MagicLeapPlanesNativeTypes")]
    
    internal static class MagicLeapPlanesNativeTypes
    {
