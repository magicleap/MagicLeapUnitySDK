...
namespace UnityEngine.XR.OpenXR.Features.MagicLeapSupport
{
    ...
    [System.Obsolete("Type has been relocated to new namespace. Update reference to MagicLeap.OpenXR.Features.MagicLeapSpatialAnchorsStorageNativeFunctions")]

    internal unsafe class MagicLeapSpatialAnchorsStorageNativeFunctions : MagicLeapFutureNativeFunctions
    {
