...
{
    public class MLConvertEditModeTests
    {
        ...
        {
            var converted = MLConvert.ToUnity(@case, transformFromRUF);
        ...
        {
            var converted = MLConvert.ToUnity(x, y, z, transformFromRUF);
            Assert.IsTrue(converted == result);
        }
        ...
        {
            Quaternion converted = MLConvert.ToUnity(@case, transformFromRUF);
        ...
        {
            Quaternion converted = MLConvert.ToUnity(Quaternion.identity, transformFromRUF);
            Assert.IsTrue(Quaternion.Angle(converted, result) == 0f);
        }
        ...
        {
            Matrix4x4 converted = MLConvert.ToUnity(@case);
            Assert.IsTrue(converted == result);
        ...
        {
            Matrix4x4 converted = MLConvert.ToUnity(@case, transformFromRUF);
            Assert.IsTrue(converted == result);
        }
        ...
        {
            var converted = MLConvert.ToUnity(@case);
            Assert.IsTrue(converted == result);
        }
        ...
        {
            MagicLeapNativeBindings.MLTransform converted = MLConvert.FromUnity(@case, transformFromRUF);
        ...
        {
            MLConvert.FromUnity(@case, ref converted);
        ...
        {
            var converted = MLConvert.FromUnity(@case, transformFromRUF);
        ...
        {
            MagicLeapNativeBindings.MLQuaternionf converted = MLConvert.FromUnity(@case, transformFromRUF);
        ...
        {
            MagicLeapNativeBindings.MLUUID converted = MLConvert.FromUnity(@case);
